...
$lang = array_merge($lang, [
    ...
    'ACP_TTS_COMPATIBILITY_MODE'                 => 'Mode compatibilité',
    'ACP_TTS_COMPATIBILITY_MODE_EXPLAIN'         => 'Charge le widget externe uniquement lorsque le visiteur clique sur Traduire. Utile pour les pages plus lourdes, les extensions de confidentialité ou les environnements où le script externe ne doit pas se charger immédiatement.',

    'ACP_TOPICTRANSLATESINGLE_SETTING_SAVED'            => 'Les paramètres ont été enregistrés avec succès !',
    'ACP_TOPICTRANSLATESINGLE_LANGUAGES_REQUIRED'       => 'Sélectionnez au moins une langue valide.',
    'ACP_TOPICTRANSLATESINGLE_ENABLED_FORUMS'           => 'IDs des forums activés',
    'ACP_TOPICTRANSLATESINGLE_ENABLED_FORUMS_EXPLAIN'   => 'Optionnel. Saisissez des IDs de forums séparés par des virgules pour limiter le traducteur à certains forums uniquement. Laissez vide pour l’autoriser sur tous les sujets.'
]);